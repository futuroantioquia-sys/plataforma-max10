@echo off
chcp 65001 >nul
title POSPARTIDO - Preparar la tabla
color 0A
mode con: cols=78 lines=40

echo.
echo  ============================================================
echo    POSPARTIDO - Preparar la tabla para GUARDAR el avance
echo  ============================================================
echo.
echo  Se corre UNA sola vez. Es la tabla donde queda guardada la
echo  planilla del partido, para que el formador pueda pausar y
echo  seguir despues. Si ya existe, no le borra nada.
echo.

set "URL=https://supabase.com/dashboard/project/fykdyalpuydkwfjqguip/sql/new?content=create%%20table%%20if%%20not%%20exists%%20public.pospartido_planillas%%20%%28%%0Atorneo_num%%20text%%20primary%%20key%%2C%%0Ajornada%%20text%%20not%%20null%%20default%%20%%27%%27%%2C%%0Afecha%%20text%%20not%%20null%%20default%%20%%27%%27%%2C%%0Allegar%%20text%%20not%%20null%%20default%%20%%27%%27%%2C%%0Arival%%20text%%20not%%20null%%20default%%20%%27%%27%%2C%%0Agoles_nos%%20text%%20not%%20null%%20default%%20%%27%%27%%2C%%0Agoles_ellos%%20text%%20not%%20null%%20default%%20%%27%%27%%2C%%0Aautogoles%%20text%%20not%%20null%%20default%%20%%27%%27%%2C%%0Afilas%%20jsonb%%20not%%20null%%20default%%20%%27%%5B%%5D%%27%%3A%%3Ajsonb%%2C%%0Aactualizada_en%%20timestamptz%%20not%%20null%%20default%%20now%%28%%29%%29%%3B%%0A%%0Aalter%%20table%%20public.pospartido_planillas%%20add%%20column%%20if%%20not%%20exists%%20filas%%20jsonb%%20not%%20null%%20default%%20%%27%%5B%%5D%%27%%3A%%3Ajsonb%%3B%%0Aalter%%20table%%20public.pospartido_planillas%%20add%%20column%%20if%%20not%%20exists%%20autogoles%%20text%%20not%%20null%%20default%%20%%27%%27%%3B%%0Aalter%%20table%%20public.pospartido_planillas%%20add%%20column%%20if%%20not%%20exists%%20actualizada_en%%20timestamptz%%20not%%20null%%20default%%20now%%28%%29%%3B%%0A%%0Aalter%%20table%%20public.pospartido_planillas%%20disable%%20row%%20level%%20security%%3B%%0Agrant%%20select%%2C%%20insert%%2C%%20update%%2C%%20delete%%20on%%20public.pospartido_planillas%%20to%%20anon%%2C%%20authenticated%%3B%%0A%%0Anotify%%20pgrst%%2C%%20%%27reload%%20schema%%27%%3B%%0A%%0A--%%20Abajo%%20debe%%20salir%%20un%%20cuadro%%20con%%20la%%20palabra%%20LISTO%%20en%%20las%%20tres%%20filas.%%0Aselect%%20%%27tabla%%20pospartido_planillas%%27%%20as%%20casilla%%2C%%0A%%20%%20%%20%%20%%20%%20%%20case%%20when%%20exists%%20%%28select%%201%%20from%%20information_schema.tables%%0A%%20%%20%%20%%20%%20%%20%%20%%20%%20%%20%%20%%20where%%20table_name%%3D%%27pospartido_planillas%%27%%29%%20then%%20%%27LISTO%%27%%20else%%20%%27FALTA%%27%%20end%%20as%%20resultado%%0Aunion%%20all%%20select%%20%%27casilla%%20filas%%27%%2C%%0A%%20%%20%%20%%20%%20%%20%%20case%%20when%%20exists%%20%%28select%%201%%20from%%20information_schema.columns%%0A%%20%%20%%20%%20%%20%%20%%20%%20%%20%%20%%20%%20where%%20table_name%%3D%%27pospartido_planillas%%27%%20and%%20column_name%%3D%%27filas%%27%%29%%20then%%20%%27LISTO%%27%%20else%%20%%27FALTA%%27%%20end%%0Aunion%%20all%%20select%%20%%27casilla%%20autogoles%%27%%2C%%0A%%20%%20%%20%%20%%20%%20%%20case%%20when%%20exists%%20%%28select%%201%%20from%%20information_schema.columns%%0A%%20%%20%%20%%20%%20%%20%%20%%20%%20%%20%%20%%20where%%20table_name%%3D%%27pospartido_planillas%%27%%20and%%20column_name%%3D%%27autogoles%%27%%29%%20then%%20%%27LISTO%%27%%20else%%20%%27FALTA%%27%%20end%%3B"
...
echo         casilla filas                LISTO
echo         casilla autogoles            LISTO
echo.
echo    Si las dos dicen LISTO, ya quedo. Vuelva a la plataforma,
echo    entre a POSPARTIDO y oprima F5.
echo.
