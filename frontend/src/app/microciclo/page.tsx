...
/* ── LA VISTA PRELIMINAR SE MUDÓ A UN COMPONENTE APARTE ───────────────
   (dirección, 03/09/2026 — «necesito ver cada microciclo de cada profesor
    en vista preliminar»)

   Esta hoja vivía aquí adentro, así que la dirección no tenía cómo verla
   sin meterse al módulo del formador. Ahora vive en
   components/VistaPreliminarMicrociclo.tsx y la usan las dos pantallas:
   esta y Control de Microciclos. Es la MISMA hoja, con el mismo PDF; solo
   cambió de sitio para poder compartirla. */
