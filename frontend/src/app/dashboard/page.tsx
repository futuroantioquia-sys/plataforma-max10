  ...
  return (
    <div className="space-y-5 sm:space-y-8">
      ...
      <CategoriaSection emoji="📊" titulo="Seguimiento" color="purple" delay={300}>
        ...
        <AccesoCard titulo="Valoración Dinámica Padres" icono={Activity}   href="/valoracion-padres" descripcion="Vista gráfica para padres"     color="dorado" />
...
function DashboardPadre() {
  ...
  const accesos = [
    ...
    { titulo: 'Valoración Deportiva',  icono: Star,          href: '/evaluaciones',     descripcion: 'Tu informe deportivo',        color: 'purple' },
    { titulo: 'Valoración Dinámica',   icono: Activity,      href: '/valoracion-padres', descripcion: 'Vista gráfica con niveles',  color: 'dorado' },
